 ...
 * itself, rather
 * an information that can be used on the control-panel and server side to
 * represent the node.
 */
public class SensorActuatorNodeInfo {
    ...
    /**
     * Constructs a {@link SensorActuatorNodeInfo} object
     * 
     * @param nodeId id of this particular node
     */
    ...
    /**
     * Add new {@link Actuator} to this node
     *
