...
public class FakeCommunicationChannel implements CommunicationChannel {
    ...
    /**
     * Creates a {@link SensorActuatorNodeInfo} from a {@link String} representation
     *
     * @param specification the string specification
     * @return new {@link SensorActuatorNodeInfo} object
     */
    ...
    /**
     * Pass on (one-by-one) substrings separated by " " (space) to be parsed as
     * actuators by another method.
     *
     * @param actuatorSpecification the space-separated {@link String}
     *                              representation of multiple actuators
     * @param info                  a {@link SensorActuatorNodeInfo} object
     */
    ...
    /**
     * Parse & create a single {@link Actuator} object from a {@link String}
     * representation, and add it to a {@link SensorActuatorNodeInfo}
     *
     * @param s    the {@link String} representation of an {@link Actuator}
     * @param info the {@link SensorActuatorNodeInfo} to add the parsed
     *             {@link Actuator} to
     */
    ...
    /**
     * Turn a {@link String} representation of many sensor-readings
     * (comma-separated) into a list of actual {@link SensorReading}.
     *
     * @param sensorInfo the {@link String} representation of all the readings
     * @return the list of all the {@link SensorReading}
     */
    ...
    /**
     * Parse a single {@link String} representation of a sensor-reading into a
     * {@link SensorReading}
     *
     * @param reading the {@link String} representation of the reading
     * @return the actual reading ({@link SensorReading})
     */
